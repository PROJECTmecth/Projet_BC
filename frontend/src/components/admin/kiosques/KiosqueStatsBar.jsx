...
export default function KiosqueStatsBar({ actifs, geles, total }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
      ...
      {/* Taux d'activité */}
      <div className="bg-blue-50 rounded-2xl px-5 py-4 sm:px-6 sm:py-5 flex items-center justify-between border border-blue-100">
        <div>
        ...
        <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-blue-100 flex items-center justify-center text-xl">
          📊
        </div>
      </div>
