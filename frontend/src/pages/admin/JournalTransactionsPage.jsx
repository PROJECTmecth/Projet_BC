  ...
  return (
    <div className="space-y-6 pb-6">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1 text-sm">Sélectionnez une plage de dates pour afficher les transactions</p>
      </div>
      ...
      >
        {/* Grand écran : tout sur une ligne | Petit écran : empilé */}
      ...
      >
        ...
        <div className="mt-6 p-5 rounded-xl shadow-xl flex items-center justify-between"
          ...
          <span className="text-3xl font-bold text-white font-mono">{formatMontant(totalCumule)} XAF</span>
        </div>
