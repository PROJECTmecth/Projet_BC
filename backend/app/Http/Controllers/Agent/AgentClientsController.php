...
class AgentClientsController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $clients = Client::with(['carte'])
            ...
            ->map(fn($c) => [
                ...
                'photo_piece_url'  => (!empty($c->photo_pieces) && is_array($c->photo_pieces) && count($c->photo_pieces) > 0)
    ...
    public function register(Request $request): JsonResponse
    {
        $request->validate([
            ...
            'photo_pieces.*'  => 'mimes:jpeg,png,jpg,gif,webp,heic,heif|image|max:10240',
            'photo_piece'     => 'sometimes|mimes:jpeg,png,jpg,gif,webp,heic,heif|image|max:10240',
